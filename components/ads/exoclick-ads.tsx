  ...
  return (
    <>
      ...
      <Script
        ...
        strategy="afterInteractive"
        dangerouslySetInnerHTML={{ __html: POPUNDER_CODE }}
      />

      {/* 3. Instant Message (Zone: 6012550) */}
      <ins className="eas6a97888e6" data-zoneid="6012550" />

      {/* 4. Sticky Banner (Zone: 6012554) */}
      <ins className="eas6a97888e17" data-zoneid="6012554" />

      {/* 5. Desktop Fullpage Interstitial (Zone: 6012560) */}
      <ins className="eas6a97888e35" data-zoneid="6012560" />
    </>
  );
}
